...
export async function saveQuote(
  ...
  return await prisma.quote.create({
    data: {
      ...
      clientState: quoteData.state || "CA",
      type: ("TERM_" + quoteData.productType) as any,
      carrier: quoteData.carrier || "TBD",
      productName: quoteData.productType || "Unknown",
      premium: quoteResult.monthlyPremium || quoteResult.premium || 0,
      coverageAmount: quoteResult.faceAmount || null,
      term: quoteResult.termLength || null,
      status: "GENERATED",
    },
  });
}
